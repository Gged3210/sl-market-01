...
export default function Product({ product }) {
  ...
  return ( 
    <>
      ...
      >
        { product?.url ? <img className="cursor-pointer object-cover h-48 w-96" src={product.url+'/190'} /> : null }
        ...
        <div className="pt-2 px-1">
          ...
          <div className="relative flex items-center text-[12px] text-gray-500">Auction</div>
